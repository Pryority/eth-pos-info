    ...
    <footer className="flex flex-col items-center w-full">
      <div className="flex flex-col items-center w-full p-8 max-w-3xl">
        <div className="flex items-center space-x-2 w-full justify-center font-light ">
          <Link href="https://ethereum.org/en/whitepaper/" className="flex items-center space-x-1 transition-all ease-in-out text-purple-50/40 hover:text-purple-100 duration-200">
