...
export const RocketPool = (props: Props) => {
  return (
    <div className="flex flex-col space-y-2 text-sm sm:text-base md:text-lg bg-clip-text text-transparent bg-gradient-to-b from-white via-white/90 to-white/70">
