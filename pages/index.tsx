    ...
    <div className='flex flex-col min-h-screen w-full justify-startitems-center p-4 sm:p-6 md:p-8 max-w-5xl'>
      ...
      <main className={"flex flex-col space-y-4 w-full items-center"}>
        ...
        <div className={"grid h-full space-y-8 md:space-y-6 leading-[20px] lg:space-y-8 md:text-xl cursor-default items-between dark:text-yellow-50 text-stone-900"}>
          ...
          {/* <Nav /> */}
          <div className="flex flex-col items-center text-center space-y-4 py-40 dark:text-white/50 text-stone-900/50">
          ...
          <div className="flex flex-col items-center space-y-2">
            ...
            <p className="opacity-75">Made by <Link href={""} className="transition-all ease-in-out hover:text-blue-600 font-bold duration-75">@EVMaverick392</Link></p>
          </div>
        </div>
      </main>
    </div>
